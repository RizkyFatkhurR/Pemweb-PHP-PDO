<?php 
    ...
    // Mengambil data dari tabel customers menggunakan fungsi showData()
    $customer = showData("SELECT*FROM customers");
    // Mengambil data dari tabel products menggunakan fungsi showData()
...
<body>
    ...
    <br><br>
    <h2><a href="InsertProduct.php">Insert New Product</a></h2>
</body>
